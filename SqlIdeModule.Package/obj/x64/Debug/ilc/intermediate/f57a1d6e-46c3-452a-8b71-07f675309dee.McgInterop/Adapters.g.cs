...
{
	public static class IBindableVector_CCWAdapter 
	{
	...
	public class IBindableVectorView_PrivateCCWAdapter : global::Windows.UI.Xaml.Interop.IBindableVectorView
	{
	    global::System.Collections.IList list;

	    public IBindableVectorView_PrivateCCWAdapter(System.Collections.IList list)
	    {
	        this.list = list;
	    }
	    
	    void EnsureIndexInt32(uint index, int listCapacity)
	    {
	        // We use '<=' and not '<' becasue Int32.MaxValue == index would imply
	        // that Size > Int32.MaxValue:
	        if (((uint)System.Int32.MaxValue) <= index || index >= (uint)listCapacity)
	...
	public static class IBindableIterable_CCWAdapter 
	{
	    public static global::Windows.UI.Xaml.Interop.IBindableIterator First(global::System.Collections.IEnumerable _this)
	    {
	        return new IBindableIterator_PrivateCCWAdapter(_this.GetEnumerator());
	    }
	}
	    ...
	    , global::Windows.Foundation.Collections.IIterator<object>
	{
	    ...
	    public virtual bool MoveNext()
	    {
	        ...
	        {
	            McgMarshal.SetExceptionErrorCode(ex, global::__Interop.McgHelpers.__HResults.E_CHANGED_STATE);
	            throw;
	        }
	...
	public static class IClosable_CCWAdapter
	{
	...
	public static class ICommand_CCWAdapter 
	{
	    /// <summary>
	        ...
	        )
	    {
	        ...
	        //
	        global::System.EventHandler handler = new global::System.EventHandler(value.Invoke);
	...
	public static class INotifyCollectionChanged_CCWAdapter 
	{
	...
	public static class INotifyPropertyChanged_CCWAdapter 
	{
